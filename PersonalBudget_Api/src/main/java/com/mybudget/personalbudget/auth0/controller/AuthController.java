...
public class AuthController {
    ...
    private static final String AUTH0_TOKEN_URL = "https://dev-jslcfanmndyz6wcl.us.auth0.com/oauth/token";
    ...
    public String getManagementApiToken() {
        ...
        requestBody.put("audience", "https://dev-jslcfanmndyz6wcl.us.auth0.com/api/v2/");
